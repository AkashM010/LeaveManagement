        ...
        <div className="animate-fade-in" data-testid="employees-page">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
                ...
                <Select value={roleFilter} onValueChange={setRoleFilter}>
                    <SelectTrigger className="w-full sm:w-[150px] rounded-lg border-slate-200">
                ...
                <Select value={departmentFilter} onValueChange={setDepartmentFilter}>
                    <SelectTrigger className="w-full sm:w-[180px] rounded-lg border-slate-200">
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                <DialogContent className="sm:max-w-md rounded-xl">
                    ...
                    <div className="space-y-4 py-2">
                        ...
                        <div>
                            <label className="text-sm font-medium text-slate-600 mb-1.5 block">Department</label>
                            <Select value={form.department} onValueChange={(v) => setForm({ ...form, department: v })}>
                                <SelectTrigger className="rounded-lg border-slate-200" data-testid="employee-department-select">
                        ...
                        <div>
                            ...
                            <Select value={form.role} onValueChange={(v) => setForm({ ...form, role: v })}>
                                <SelectTrigger className="rounded-lg border-slate-200" data-testid="employee-role-select">
                                    <SelectValue />
                                </SelectTrigger>
                                <SelectContent>
                                    <SelectItem value="employee">Employee</SelectItem>
                        ...
                        {form.role !== "admin" && (
                            <div>
                                <label className="text-sm font-medium text-slate-600 mb-1.5 block">Assign Manager (Optional)</label>
                                <Select value={form.manager_id} onValueChange={(v) => setForm({ ...form, manager_id: v === "none" ? "" : v })}>
                                    <SelectTrigger className="rounded-lg border-slate-200" data-testid="employee-manager-select">
