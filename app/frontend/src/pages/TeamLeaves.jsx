                ...
                <Card className="app-card border-slate-200">
                    <CardContent className="p-0 divide-y divide-slate-100">
                        {filtered.map((leave) => {
                            ...
                            return (
                                <div key={leave.id} className="modern-table-row px-5 flex items-start justify-between gap-4" data-testid={`team-leave-${leave.id}`}>
                                    <div className="flex items-start gap-4 flex-1">
                                        ...
                                        <div className="flex-1">
                                            <div className="flex items-center gap-2 mb-1">
                                                <p className="text-sm font-semibold tracking-wide text-slate-800">{leave.employee_name}</p>
                                                {category && (
                                    ...
                                    {canApprove(leave) && (
                                        <div className="flex gap-2 shrink-0">
                                            <Button
                                                ...
                                                className="bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-xs px-3 h-8 transition-all duration-200 active:scale-95 shadow-sm"
                                            ...
                                            <Button
                                                ...
                                                className="border-rose-200 text-rose-600 hover:bg-rose-50 rounded-lg text-xs px-3 h-8 transition-all duration-200 active:scale-95 shadow-sm"
